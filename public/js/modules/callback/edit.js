        ...
        data: function () {
            var options = {
                ...
                data: {
                    ...
                    source: {
                        read: {
                            url: DOMAIN + 'lead/list/'+startdate.format("YYYY-MM-DD")+'/'+enddate.format("YYYY-MM-DD"),
                        },
                    },
                    pageSize: 10,
                    serverPaging: false,
                ...
                columns: [{
                    ...
                    template: function(row){
                        var data = "";
                        if(!row.deleted_at){
                            is_view = `<a class="btn btn-icon btn-xs btn-light-warning btn-circle mr-2 view" href="javascript:;" data-url="lead/show/${row.id}" data-size="xl" data-title="Show Lead"><i class="nav-icon la la-eye"></i></a>`;
                            is_edit = `<a class="btn btn-icon btn-xs btn-light-info btn-circle mr-2 edit" href="javascript:;" data-url="lead/edit/${row.id}" data-title="Edit Lead" data-size="xl" title="Edit"><i class="nav-icon la la-edit"></i> </a>`;
                            ...
                            is_convert = `<a class="btn btn-icon btn-xs btn-light-warning btn-circle mr-2 convert" href="javascript:" data-url="lead/convert/${row.id}" data-title="Convert Lead" data-size="xl"><i class="nav-icon la la-edit"></i></a>`;
