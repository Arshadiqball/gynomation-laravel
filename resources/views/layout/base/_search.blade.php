<!--begin::Subheader-->
<div class="subh  eader py-5 py-lg-10 gutter-b subheader-transparent" id="kt_subheader" style="background-color: #663259; background-position: right bottom; background-size: auto 100%; background-repeat: no-repeat; background-image: url('media/svg/patterns/taieri.svg') }})">
    <div class="container d-flex flex-column">
        <!--begin::Title-->
        <div class="d-flex align-items-sm-end flex-column flex-sm-row mb-5">
            <h2 class="d-flex align-items-center text-white mr-5 mb-0">Global Search </h2>
            <span class="text-white opacity-60 font-weight-bold">(Teacher, Student, Parent, Supervisor search by location or name) </span>
        </div>
        <!--end::Title-->
        <!--begin::Search Bar-->
            ...
            <div class="bg-white rounded p-4 d-flex flex-grow-1 flex-sm-grow-0">
                ...
                <form class="form d-flex align-items-md-center flex-sm-row flex-column flex-grow-1 flex-sm-grow-0">
                    ...
                    <div class="d-flex align-items-center py-3 py-sm-0 px-sm-3">
                        ...
                        <input type="text" class="form-control border-0 font-weight-bold pl-2" placeholder="Name" />
                    </div>
                    <!--end::Input-->
                    <!--begin::Input-->
                    ...
                    <div class="d-flex align-items-center py-3 py-sm-0 px-sm-3">
                        ...
                        <input type="text" class="form-control border-0 font-weight-bold pl-2" placeholder="Role" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-target="kt_searchbar_7_category-options" data-offset="0,10" readonly="readonly" />
                        <div id="kt_searchbar_7_category-options" class="dropdown-menu dropdown-menu-sm">
                            <div class="dropdown-item cursor-pointer">Teacher</div>
                            <div class="dropdown-item cursor-pointer">Student</div>
                            <div class="dropdown-item cursor-pointer">Parent</div>
                            <div class="dropdown-item cursor-pointer">Supervisor</div>
                        </div>
                    </div>
                    <!--end::Input-->
                    <!--begin::Input-->
                    ...
                    <div class="d-flex align-items-center py-3 py-sm-0 px-sm-3">
                        <span class="svg-icon svg-icon-lg">
                            <!--begin::Svg Icon | path:{{ asset('media/svg/icons/Media/Rec.svg') }}-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24" />
